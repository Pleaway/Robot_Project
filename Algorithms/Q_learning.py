...
def training(grid=Grid(), Q_learn=None, num_training=10000, alpha=0.1, gamma=0.9, epsilon=1, epsilon_min=0, epsilon_decay=0.995, stats=False):
    target = grid.end
    if Q_learn is None:
    ...
    grid.Q = Q
    if stats:
        return length_list, rewards_list
    else :
        return Q
