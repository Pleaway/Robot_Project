...
def comparison(rows=100, cols=100, nb_training=2500, alphas=[0.1], gammas=[0.9], min_length=75):
...
def comparison_apf(rows=100, cols=100, nb_training=2500, alpha=0.9, gamma=0.999, min_length=100):
    ...
    step_list_, reward_list_ = training(grid=G, num_training=nb_training, stats=True, alpha=alpha, gamma=gamma, init_matrix=init_Q_APF)
